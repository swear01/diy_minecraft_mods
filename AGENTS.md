...
- `Magic_Storage/` is its **own git repo** with its own `AGENTS.md` + `docs/`. Work inside it under those rules.
- `Karst_terrian/` is part of this repo; it has no separate AGENTS.md and is governed by these rules.
